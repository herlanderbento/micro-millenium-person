import EducationValidatorFactory, {
  EducationValidator,
...
describe("EducationValidator Tests", () => {
  ...
  beforeEach(() => (validator = EducationValidatorFactory.create()));
  ...
  test("invalidation cases for personId field", () => {
    ...
    expect({ validator, data: { personId: 5 as any } }).containsErrorMessages({
      personId: [
        "personId must be a string",
        "personId must be shorter than or equal to 255 characters",
      ],
