...
describe('EducationFakerBuilder Unit Tests', () => {
  describe('entityId prop', () => {
    const faker = EducationFakeBuilder.aEducation();
    ...
    test('withUuid', () => {
      ...
      expect($this).toBeInstanceOf(EducationFakeBuilder);
    ...
    test('should pass index to entityId factory', () => {
      ...
      const educationId = new Uuid();
      mockFactory = jest.fn(() => educationId);
      const fakerMany = EducationFakeBuilder.theEducations(2);
  ...
  describe('personId props', () => {
    ...
    test('should pass index to personId factory', () => {
      ...
      const fakerMany = EducationFakeBuilder.theEducations(2);
      fakerMany.withPersonId(
        (index) => `670d7397-7cd6-4bba-b450-73ae6376048c ${index}`
      );
      const educations = fakerMany.build();

      expect(educations[0].personId).toBe(
        `670d7397-7cd6-4bba-b450-73ae6376048c 0`
      );
      expect(educations[1].personId).toBe(
        `670d7397-7cd6-4bba-b450-73ae6376048c 1`
      );
    });
  ...
  describe('educationType props', () => {
    ...
    test('withEducationType', () => {
      ...
      //@ts-expect-error educationType is callable
      expect(faker['_educationType']()).toBe('test educationType');
  ...
  describe('institute props', () => {
    ...
    test('withInstitute', () => {
      ...
      //@ts-expect-error institute is callable
      expect(faker['_institute']()).toBe('test institute');
  ...
  describe('createdAt props', () => {
    ...
    test('should throw error when any with methods has called', () => {
      const fakerEducation = EducationFakeBuilder.aEducation();
      expect(() => fakerEducation.createdAt).toThrowError(
  ...
  describe('updatedAt props', () => {
    ...
    test('should throw error when any with methods has called', () => {
      const fakerEducation = EducationFakeBuilder.aEducation();
      expect(() => fakerEducation.updatedAt).toThrowError(
  ...
  test('should create a education', () => {
    ...
    expect(education.entityId).toBeInstanceOf(Uuid);
  ...
  test('should create many educations', () => {
    const faker = EducationFakeBuilder.theEducations(4);
