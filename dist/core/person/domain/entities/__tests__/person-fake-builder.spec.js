...
describe('PersonFakeBuilder', () => {
    describe('entityId prop', () => {
        const faker = person_fake_builder_1.PersonFakeBuilder.aPerson();
        ...
        test('withUuid', () => {
            ...
            expect($this).toBeInstanceOf(person_fake_builder_1.PersonFakeBuilder);
        ...
        test('should pass index to entityId factory', () => {
            ...
            const personId = new domain_1.Uuid();
            mockFactory = jest.fn(() => personId);
            const fakerMany = person_fake_builder_1.PersonFakeBuilder.thePersons(2);
    ...
    describe('userId props', () => {
        ...
        test('should pass index to userId factory', () => {
            faker.withUserId((index) => `670d7397-7cd6-4bba-b450-73ae6376048c ${index}`);
            const Person = faker.build();
            expect(Person.userId).toBe(`670d7397-7cd6-4bba-b450-73ae6376048c 0`);
            const fakerMany = person_fake_builder_1.PersonFakeBuilder.thePersons(2);
            fakerMany.withUserId((index) => `670d7397-7cd6-4bba-b450-73ae6376048c ${index}`);
    ...
    describe('shareableSection props', () => {
        ...
        test('should pass index to shareableSection factory', () => {
            ...
            const fakerMany = person_fake_builder_1.PersonFakeBuilder.thePersons(2);
            fakerMany.withShareableSection((index) => `test shareableSection ${index}`);
            const persons = fakerMany.build();
    ...
    describe('createdAt props', () => {
        const faker = person_fake_builder_1.PersonFakeBuilder.aPerson();
        test('should throw error when any with methods has called', () => {
            const fakerperson = person_fake_builder_1.PersonFakeBuilder.aPerson();
            expect(() => fakerperson.createdAt).toThrowError(new Error("Property createdAt not have a factory, use 'with' methods"));
        });
        test('should be undefined', () => {
    ...
    describe('updatedAt props', () => {
        ...
        test('should throw error when any with methods has called', () => {
            const fakerperson = person_fake_builder_1.PersonFakeBuilder.aPerson();
            expect(() => fakerperson.updatedAt).toThrowError(new Error("Property updatedAt not have a factory, use 'with' methods"));
        });
        test('should be undefined', () => {
    ...
    test('should create a person', () => {
        ...
        expect(person.entityId).toBeInstanceOf(domain_1.Uuid);
    ...
    test('should create many persons', () => {
        const faker = person_fake_builder_1.PersonFakeBuilder.thePersons(16);
