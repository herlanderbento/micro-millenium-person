...
describe('ListPersonsUseCase Unit Tests', () => {
    ...
    beforeEach(() => {
        ...
        useCase = new list_persons_use_case_1.ListPersonsUseCase(repository);
    });
    test('toOutput method', () => {
        let result = new domain_1.PersonSearchResult({
            items: [],
            total: 1,
            current_page: 1,
            per_page: 2,
        ...
        result = new domain_1.PersonSearchResult({
            items: [entity],
            total: 1,
            current_page: 1,
            per_page: 2,
    ...
    it('should return output sorted by createdAt when input param is empty', async () => {
        const entity1 = new domain_1.Person({
            userId: '9b1deb4d-3b7d-4bad-9bdd-2b0d7b3dcb6d',
            gender: 'male',
            address: 'address',
            birthdate: new Date('2001-07-15T09:29:58.242Z'),
        ...
        const entity2 = new domain_1.Person({
            userId: '9b1deb4d-3b7d-4bad-9bdd-2b0d7b3dcb6d',
            gender: 'male',
            address: 'address',
            birthdate: new Date('2001-07-15T09:29:58.242Z'),
